...
export default function EcosystemSection() {
  ...
  return (
    <section id="ecosystem" className="py-10 md:py-16 overflow-hidden" style={{ backgroundColor: "#F0EBE1", scrollMarginTop: "60px", maxWidth: "100vw", width: "100%", borderTop: "1px solid rgba(196,149,106,0.08)" }}>
