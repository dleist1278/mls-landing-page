                                  ...
                                  {/* Headline */}
                                            <div className={`transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                                                          <h1
                                                                          ...
                                                                          <br />
                                                                          <em style={{ color: "#4D5E49" }}>Modern Motherhood.</em>em>
                                                          </h1>h1>
                                            </div>div>
                                  ...
                                  {/* Subheadline */}
                                            <div className={`transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                                                          <p
                                                                          ...
                                                                          Build a <strong style={{ color: "#2C2C2C", fontWeight: 500 }}>flexible childcare business</strong>strong><br />around your life, your family, and your goals.
                                                          </p>p>
                                            </div>div>
