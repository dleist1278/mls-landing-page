    ...
    <section className="relative min-h-[70vh] flex items-center overflow-hidden" style={{ backgroundColor: "#FAF7F2" }}>
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          style={{ objectPosition: "center 35%", opacity: 0.25 }}
        />
        <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-20 pb-16 w-full">
        ...
        <div style={{ maxWidth: "560px", flex: "0 0 auto" }}>
          ...
          <div className={`transition-all duration-700 delay-100 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            <p className="font-micro mb-7 inline-flex items-center gap-3" style={{ color: "#C4956A", fontSize: "0.72rem" }}>
              <span className="inline-block w-8 h-px" style={{ backgroundColor: "#C4956A" }} />
              The Mama Launch Method — Early Access
            </p>
          </div>

          {/* Headline — readable, clean, no fragmented line breaks */}
          ...
          <div className={`transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <p className="font-body mb-5" style={{ color: "#5C5148", fontSize: "1.1rem", lineHeight: "1.7", maxWidth: "480px" }}>
          ...
          <div className={`transition-all duration-700 delay-500 flex flex-wrap gap-4 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <button
              ...
              style={{ backgroundColor: "#4D5E49", fontSize: "0.8rem", boxShadow: "0 8px 32px rgba(77,94,73,0.28)" }}
            >
