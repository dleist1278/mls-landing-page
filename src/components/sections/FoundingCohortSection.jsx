    ...
    <section style={{ backgroundColor: "#FAF7F2", borderTop: "1px solid rgba(196,149,106,0.08)" }}>
      ...
      >
        ...
        <p
          ...
          style={{ color: "#5C5148", fontSize: "1.1rem", lineHeight: "1.7", maxWidth: "40ch", ...anim(0.26) }}
        >
          ...
          {milestones.map((m, i) => (
            <div key={m.label}>
              <div className="flex items-center gap-3 py-2.5 px-4 rounded-xl"
                ...
                <span className="font-body" style={{ color: "#7A6E65", fontSize: "0.92rem", flex: 1, textAlign: "left" }}>{m.label}</span>
