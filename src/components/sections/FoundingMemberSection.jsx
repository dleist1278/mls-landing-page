      ...
      <div
        ...
        <div className="flex items-center gap-3 px-5 py-4">
          ...
          <div className="flex-1">
            <h3 className="font-display text-[23px] leading-snug" style={{ color: "#2C2C2C" }}>{step.title}</h3>
            <p className="font-micro mt-0.5" style={{ color: "#C4956A", fontSize: "0.66rem", letterSpacing: "0.1em" }}>{step.sub}</p>
          </div>
        </div>
        {isOpen &&
        <div className="px-5 pb-4" style={{ borderTop: "1px solid #F0EBE3" }}>
            <p className="pt-3 text-[19px] leading-relaxed" style={{ color: "#7A6E65", maxWidth: "38ch", lineHeight: "1.68" }}>{step.description}</p>
          </div>
        }
      </div>
    </div>);
