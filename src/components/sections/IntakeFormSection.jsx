...
export default function IntakeFormSection() {
  ...
  const selectStyle = {
    ...
    fontSize: "1rem",
    color: form.state || form.role || form.interest || form.hesitation ? "#2C2C2C" : "#9a8f84",
    width: "100%",
    outline: "none",
    cursor: "pointer",
        ...
        >
          ...
          {submitted ? (
            <div
              ...
              style={{
                animation: "atmosphericEntrance 0.9s ease-out forwards",
              }}
            >
              <div
                className="w-16 h-16 rounded-full mx-auto mb-8 flex items-center justify-center"
                style={{ backgroundColor: "#4D5E4915" }}
              >
                <div
              ...
              >
                We've received your information and we're so glad you're here. Expect a warm, personal note in your inbox within 24 hours — along with your personalized next steps.
              </p>
              <p
                className="font-micro mt-8"
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div>
                  <label
                    className="font-micro block mb-3"
                    style={{ color: "#9a8f84", fontSize: "0.7rem" }}
                  >
                    First Name
                  </label>
                  <input
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="relative">
                  ...
                  >
                    ...
                    {roles.map((r) => (
                      <option key={r} value={r} style={{ color: "#2C2C2C" }}>{r}</option>
                    ))}
                  </select>
                  <span
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {interests.map((i) => (
                      <option key={i} value={i} style={{ color: "#2C2C2C" }}>{i}</option>
                    ))}
                  </select>
                  <span
                    className="absolute right-0 bottom-4 pointer-events-none"
              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {hesitations.map((h) => (
                      <option key={h} value={h} style={{ color: "#2C2C2C" }}>{h}</option>
                    ))}
                  </select>
                  <span
                    className="absolute right-0 bottom-4 pointer-events-none"
              ...
              <div className="pt-4 flex flex-col items-center gap-5">
                <button
                  type="submit"
                  className="font-micro text-white px-12 py-5 rounded-full hover:opacity-90 transition-all min-h-[56px] focus-sage"
                  style={{
