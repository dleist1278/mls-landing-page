      ...
      <div className="hidden md:block">
        ...
        <div className="text-center mx-auto px-8 pt-16 pb-8" style={{ maxWidth: "720px" }}>
          ...
          <p
            ...
            style={{
            color: "#5C5148", fontSize: "1.25rem", lineHeight: "1.75", maxWidth: "58ch",
              opacity: visible ? 1 : 0,
              animation: visible ? "methodFadeUp 0.8s ease forwards" : "none",
              animationDelay: "0.2s"
            }}
                    ...
                    <div style={{
                      ...
                      <div style={{ padding: "22px 28px 24px" }}>
                        <div style={{ marginBottom: "10px" }}>
                          ...
                          <h3 className="font-display" style={{ color: "#2C2C2C", fontSize: "clamp(1.3rem, 1.8vw, 1.65rem)", lineHeight: "1.2", letterSpacing: "-0.02em" }}>
                            {phase.name}
                          </h3>
                        </div>
                        <p className="font-body" style={{ color: "#3a3228", fontSize: "1.125rem", lineHeight: "1.68", marginBottom: "14px" }}>
                          {phase.outcome}
                        </p>
        ...
        >
          ...
          <p className="font-body mb-8" style={{ color: "#7A6E65", fontSize: "1.2rem", lineHeight: "1.75" }}>
